        ...
        <section className="pt-12 bg-white">
            <Element name="Why Healix">
                <div className="container">
                    ...
                    <div className="flex gap-12 md:flex-nowrap sm:flex-wrap md:overflow-hidden max-md:flex-col max-md:border-none max-md:rounded-none max-md:gap-5">
                            ...
                            <div className="grid grid-cols-11 gap-4 rounded-lg">
                                {comparisonTable.map(({ id, feature, healixInfo, conventionMedicineInfo }) => (
                                    <div key={id} className="contents">
                                        ...
                                        <div className="p-4 bg-s1 text-sm text-gray-700 col-span-4 rounded">
                        ...
                        <div className="basis-1/2 mt-3 mb-3">
                            {reasons.map(({ id, title, text }) => (
                                ...
                                >
                                    <h2 className="mb-1 text-2xl text-p4 max-md:mb-3 max-md:h5">{title}</h2>
