...
export const comparisonTable = [
    {
        ...
        healixInfo: "Holistic: Body, mind, and environment",
        conventionMedicineInfo: "Specialized: focuses on treating isolated symptoms",
    },
    {
        id: "1",
        feature: "Access to Practitioners",
        healixInfo: " 24/7 virtual and in-person consultations worldwide",
        conventionMedicineInfo: " Often long wait times for in-person visits",
    },
    {
        id: "2",
        feature: "Personalized Plans",
        healixInfo: "Plans tailored to unique needs",
        conventionMedicineInfo: "Standardized treatments based on protocols",
    },
    {
        id: "3",
        feature: "Remedies",
        healixInfo: "Natural medicines, vitamins, supplements",
        conventionMedicineInfo: "Pharmaceutical interventions, often chemical-based",
    },
    {
        id: "4",
        feature: "Preventative Care",
        healixInfo: "Strong focus on lifestyle, diet, and prevention",
...
export const howItWorksPartners = [
    {
        id: "0",
        icon: "join",
        iconColor: "bg-orange-200",
...
export const clientNewsletter = {
    ...
    get: [
        ...
        { id: "2", desc: "Virtual and in-person consultations for holistic care" },
        { id: "3", desc: "Trusted by Thousands of Patients Worldwide" },
    ],
};

export const partnerNewsletter = {
    bgColor: "bg-p2",
    title: "Grow Your Practice with Healix",
    description:
    ...
    get: [
        ...
        {
            id: "2",
            desc: "Get access to a secure, easy-to-use platform to manage bookings, payments and consultations.",
        },
        { id: "2", desc: "Access content and tools to enhance your practice and patient care." },
    ],
};
...
export const offers = [
    {
        ...
        benefits: [
            {
                id: "0",
                description: "Wellness Counseling",
            },
            {
                id: "1",
                description: "Integrative Therapeutic Approaches",
            },
            {
                id: "2",
                description: "Mind-Body Therapies",
            },
        ],
    },

    {
        ...
        benefits: [
            ...
            {
                id: "1",
                description: "Homeopathic treatments",
            },
            {
                id: "2",
    ...
    },
    {
        ...
        benefits: [
            ...
            {
                id: "1",
                description: "Genetic and Nutritional Analysis",
            },
            {
                id: "2",
    ...
    },
    {
        ...
        benefits: [
            {
                id: "0",
                description: "Spinal Adjustments",
            },
            {
                id: "1",
    ...
    },
    {
        ...
        benefits: [
            ...
            {
                id: "2",
                description: "Spiritual Healing, Panchakarma and Qi Gong",
            },
        ],
    },
    {
        ...
        benefits: [
            ...
            {
                id: "1",
                description: "Functional Foods & Supplements",
            },
            {
                id: "2",
...
export const reviews = [
    {
        ...
        comment:
            "I’ve never felt so understood in my healthcare journey. Healix connected me with a practitioner who truly listened and helped me address the root cause of my issues. After six years of chronic illness, I am healing.",
    },
    {
        id: "1",
        name: "Mark Erixon",
